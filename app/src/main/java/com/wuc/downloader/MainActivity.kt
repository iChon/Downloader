...
import com.wuc.download.DownloadListener
import com.wuc.download.Downloader
import com.wuc.download.engin.HttpUrlConnectProxy
...
class MainActivity : AppCompatActivity() {
    ...
    private fun download(url: String, desDir: File) {
        object : Thread(){
            override fun run() {
                Downloader.download(desDir, HttpUrlConnectProxy(url), object : DownloadListener {
